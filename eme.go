...
const (
	// DirectionEncrypt Encrypt "inputData"
	DirectionEncrypt = directionConst(true)
	// DirectionDecrypt Decrypt "inputData"
	DirectionDecrypt = directionConst(false)
)

// multiByTwo - GF multiplication as specified in the EME-32 draft
func multiByTwo(out []byte, in []byte) {
	if len(in) != 16 {
